...
public class PopGenre extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.action_home:
                        Toast.makeText(PopGenre.this, "Home", Toast.LENGTH_SHORT).show();
                        Intent intent1=new Intent(PopGenre.this,MainActivity.class);
                        startActivity(intent1);
                        break;
                    case R.id.action_search:
                        Toast.makeText(PopGenre.this, "Search", Toast.LENGTH_SHORT).show();
                        Intent intent2=new Intent(PopGenre.this,searchBar.class);
                        startActivity(intent2);
                        break;
                    case R.id.action_profile:
                        Toast.makeText(PopGenre.this, "Profile", Toast.LENGTH_SHORT).show();
                        Intent intent3=new Intent(PopGenre.this,ProfileActivity.class);
