...
public class RepeatsPlaylist extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.action_home:
                        Toast.makeText(RepeatsPlaylist.this, "Home", Toast.LENGTH_SHORT).show();
                        Intent intent1=new Intent(RepeatsPlaylist.this,LaunchScreen.class);
                        startActivity(intent1);
                        break;
                    case R.id.action_search:
                        Toast.makeText(RepeatsPlaylist.this, "Search", Toast.LENGTH_SHORT).show();
                        Intent intent2=new Intent(RepeatsPlaylist.this,searchBar.class);
                        startActivity(intent2);
                        break;

                    case R.id.action_profile:
                        Toast.makeText(RepeatsPlaylist.this, "Profile", Toast.LENGTH_SHORT).show();
                        Intent intent3=new Intent(RepeatsPlaylist.this,ProfileActivity.class);
