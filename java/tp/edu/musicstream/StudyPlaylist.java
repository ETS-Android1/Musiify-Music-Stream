            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.action_home:
                        Toast.makeText(StudyPlaylist.this, "Home", Toast.LENGTH_SHORT).show();
                        Intent intent1=new Intent(StudyPlaylist.this,LaunchScreen.class);
                        startActivity(intent1);
                        break;
                    case R.id.action_search:
                        Toast.makeText(StudyPlaylist.this, "Search", Toast.LENGTH_SHORT).show();
                        Intent intent2=new Intent(StudyPlaylist.this,searchBar.class);
                        startActivity(intent2);
                        break;

                    case R.id.action_profile:
                        Toast.makeText(StudyPlaylist.this, "Profile", Toast.LENGTH_SHORT).show();
                        Intent intent3=new Intent(StudyPlaylist.this,ProfileActivity.class);
